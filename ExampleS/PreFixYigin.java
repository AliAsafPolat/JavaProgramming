...
public class Main {
    ...
    public static void main(String[] args) {
                ...
                System.out.println("İfadeyi PreFix olarak giriniz.");
                String ifade=scan.nextLine();
                int lengthifade=ifade.length();

                //int yiginindex=0;
                for(int i=lengthifade-1;i>=0;i--){      //PostFix den farklı olan kısmı tersten alması.
                    ...
                    if(ifade.charAt(i)<='9'&&ifade.charAt(i)>='1'){
                        ...
                        k=k/l;          //PostFixden farklı olan bir kısım bu işlemlerin sırası
                        yigin.push(k);
